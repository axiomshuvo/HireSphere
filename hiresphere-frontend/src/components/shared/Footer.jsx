          ...
          <div className="md:col-span-5 flex flex-col justify-between gap-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-xl bg-[#6366f1] hover:bg-[#4f46e5] flex items-center justify-center text-white transition-all duration-200 shadow-md shadow-indigo-500/20"
