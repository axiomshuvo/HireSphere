  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-default bg-content1 px-6 py-20 text-center">
      <div className="relative mb-8">
        ...
        <div className="absolute -right-2 -top-2 flex size-10 items-center justify-center rounded-full border border-default bg-content1 text-white shadow-lg">
          <CirclePlus className="size-5" />
        </div>
      </div>

      <Typography.Heading className="text-2xl font-semibold text-white" level={2}>
